...
umg::utf8_illustration umg::utf8_h_line::illustrate() const
{
...
umg::utf8_illustration umg::utf8_v_line::illustrate() const
{
    utf8_illustration illustration;
...
int get_max_utf8_string_size(std::vector<std::string> const& text)
{
    ...
    for (auto const& byte_string : text)
        max_utf8_string_size = std::max(max_utf8_string_size, umg::measure_utf8_string_size(byte_string));

    return max_utf8_string_size;
}

umg::utf8_text_rectangle::utf8_text_rectangle(
    int const x_pos, int const y_pos,
...
umg::utf8_illustration umg::utf8_text_rectangle::illustrate() const
{
    utf8_illustration illustration;
