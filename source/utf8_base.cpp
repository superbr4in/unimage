...
size_t umg::measure_utf8_string_size(std::string byte_string)
{
    size_t size = 0;
...
umg::utf8_char::utf8_char(std::string const& byte_string)
{
...
std::ostream& umg::operator<<(std::ostream& stream, std::vector<std::vector<umg::utf8_char>> utf8_illustration)
{
