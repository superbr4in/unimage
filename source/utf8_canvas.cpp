...
umg::utf8_canvas::utf8_canvas(int const width)
    : width_(std::max(0, width)) { }

void umg::utf8_canvas::add_shape(int const layer, std::unique_ptr<utf8_shape const> shape)
{
    operator[](layer).push_back(std::move(shape));
}

umg::utf8_illustration umg::utf8_canvas::illustrate() const
{
